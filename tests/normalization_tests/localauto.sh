...
clang++ ./code/automated.cpp comparison_utils.o  differential_fuzzer.o  normalization_test_utils.o  yamlcpp_parser.o  yaml_normalized_output.o \
...
-I ../../differential_fuzzing_lib/ -g -fsanitize=address -o autotest