...
Toy2ParserOutput::Toy2ParserOutput(std::string* info, std::string* error_code)
{
    this->data = info;
    this->error = error_code;
}

Toy2ParserOutput::~Toy2ParserOutput()
{
...
bool Toy2ParserOutput::equivalent(ParserOutput* compared_object)
{
...
void* Toy2ParserOutput::getData()
{
    return static_cast<void*>(this->data);
}

std::string* Toy2ParserOutput::getError()
{
    return this->error;
}
...
std::string Toy2Parser::getName()
{
    return "toy-2";
}


void* Toy2Parser::parse(const uint8_t* input, size_t input_size, std::string* error_code)
{
