...
void runTestAll()
{
    ...
    differential_parser::Parser* array_of_parsers[7] = {(differential_parser::Parser*)(&toyl_case),
        (differential_parser::Parser*)(&toy2_case), (differential_parser::Parser*)(&toy3_case), 
    ...
    assess(!differential_fuzzer::fuzzer::DifferentiallyFuzz(array_of_parsers, 7, Data, size));
}
